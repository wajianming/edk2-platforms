...
PLATFORM_IIO_CONFIG_UPDATE_TABLE_EX  TypeSMCIx12SPWIioConfigTable =
{
...
)
{
  ...
  //
  PlatformIioInfoPtr = &TypeSMCIx12SPWIioConfigTable;
  PlatformIioInfoSize = sizeof(TypeSMCIx12SPWIioConfigTable);
