...
static UINT8 TypeSMCIx12SPWPchPciSlotImpementedTableData[] = {
...
PLATFORM_PCH_PCI_SLOT_IMPLEMENTED_UPDATE_TABLE TypeSMCIx12SPWPchPciSlotImplementedTable = {
  PLATFORM_SLOT_UPDATE_SIGNATURE,
  PLATFORM_SLOT_UPDATE_VERSION,

  TypeSMCIx12SPWPchPciSlotImpementedTableData
};
...
)
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &TypeSMCIx12SPWPchPciSlotImplementedTable,
                                 sizeof(TypeSMCIx12SPWPchPciSlotImplementedTable)
                                 );
  if (EFI_ERROR(Status)) {
    return Status;
  }
