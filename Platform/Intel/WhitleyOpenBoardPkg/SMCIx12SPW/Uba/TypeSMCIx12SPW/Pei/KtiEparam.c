...
ALL_LANES_EPARAM_LINK_INFO  KtiSMCIx12SPWIcxAllLanesEparamTable[] = {
  //
...
PLATFORM_KTI_EPARAM_UPDATE_TABLE  TypeSMCIx12SPWIcxKtiEparamUpdate = {
  PLATFORM_KTIEP_UPDATE_SIGNATURE,
  PLATFORM_KTIEP_UPDATE_VERSION,
  KtiSMCIx12SPWIcxAllLanesEparamTable,
  sizeof (KtiSMCIx12SPWIcxAllLanesEparamTable),
  NULL,
  0
};
...
)
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &TypeSMCIx12SPWIcxKtiEparamUpdate,
                                 sizeof(TypeSMCIx12SPWIcxKtiEparamUpdate)
                                 );
