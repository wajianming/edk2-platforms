...
VOID TypeSMCIx12SPWPlatformUpdateVrIdAddress (VOID);

/**
  Update SMCIx12SPW IMON SVID Information

  retval N/A
**/
VOID
TypeSMCIx12SPWPlatformUpdateImonAddress (
  VOID
  )
{
...
**/
VOID
TypeSMCIx12SPWPlatformUpdateVrIdAddress (
  VOID
  )
{
...
EFI_STATUS
TypeSMCIx12SPWPlatformPcdUpdateCallback (
  VOID
)
{
  ...
  CHAR16    PlatformName[]   = L"TypeSMCIx12SPW";
  UINTN     PlatformNameSize = 0;
  EFI_STATUS Status;

  //#Integer for BoardID, must match the SKU number and be unique.
  Status = PcdSet16S (PcdOemSkuBoardID                      , TypeSMCIx12SPW);
  ...
  Status = TypeSMCIx12SPWPlatformUpdateAcpiTablePcds ();
...
PLATFORM_PCD_UPDATE_TABLE    TypeSMCIx12SPWPcdUpdateTable =
{
...
)
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &TypeSMCIx12SPWPcdUpdateTable,
                                 sizeof(TypeSMCIx12SPWPcdUpdateTable)
                                 );
